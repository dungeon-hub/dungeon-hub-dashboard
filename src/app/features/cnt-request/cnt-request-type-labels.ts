 ...
 */
export const CNT_REQUEST_TYPE_LABELS: Record<
	CntRequestUpdateModel.RequestTypeEnum,
	string
> = {
	...
	[CntRequestUpdateModel.RequestTypeEnum.TWOHUNDRED_TO_FOURHUNDRED]:
		"200M - 400M",
 ...
 */
export function getCntRequestTypeLabel(
	requestType: CntRequestUpdateModel.RequestTypeEnum | undefined | null,
): string {
