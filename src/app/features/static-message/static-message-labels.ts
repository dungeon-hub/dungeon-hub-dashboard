import type { StaticMessageCreationModel } from "@dungeon-hub/api-client";
...
export const STATIC_MESSAGE_TYPES = Object.keys(
	STATIC_MESSAGE_TYPE_LABELS,
) as StaticMessageType[];
